...
//send the token in a cookie do the browser be abele to store it
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  if(!user.active) {
    return next(new AppError('User is not active to activate to user again talk to system admin', 401));
  }
...
//Check user has the correct role for the action
